...
export const question: QuestionData = {
  ...
  id: 'jya24m',
  en: {
    question: 'It was the first province to be explored and founded in northern Mexico during the viceroyalty of New Spain',
    answer: 'New Vizcaya',
    options: [
      "New Galicia",
      "New Navarre",
  ...
  zh: {
    question: '这是在新西班牙总督辖区期间，墨西哥北部第一个被探索和建立的省份',
    answer: '新比斯卡亚',
    options: [
      "新加利西亚",
      "新纳瓦拉",
