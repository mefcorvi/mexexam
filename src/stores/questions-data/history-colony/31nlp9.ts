...
export const question: QuestionData = {
  ...
  id: '31nlp9',
  en: {
    question: 'In the time of New Spain, what were obrajes?',
    answer: 'They were artisanal centers that existed in the mid-16th century, with an average of 50 workers, where textiles, threads, and coarse wool were produced. These products were sold to Indians and mulattoes, who could not afford the price of the same product imported from Europe. The workers were Indians and convicts sentenced for crimes who were exploited by the obrajeros.'
  },
  ru: {
