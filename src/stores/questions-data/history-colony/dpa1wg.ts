...
export const question: QuestionData = {
  ...
  id: 'dpa1wg',
  en: {
    question: 'In the colonial era, who were called peons?',
    answer: 'The wage workers of the estates',
    options: [
      "The estate owners",
      "The peasants who worked on smallholdings",
      "The children of Spaniards and Indians"
    ]
  },
  ru: {
