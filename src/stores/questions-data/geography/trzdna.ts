...
export const question: QuestionData = {
  ...
  id: 'trzdna',
  en: {
    question: 'How many peninsulas does Mexico have?',
    answer: '2, Peninsulas of Baja California and Yucatán',
    options: [
      "2, Peninsulas of Chiapas and Yucatán",
      "2, Peninsulas of Baja California and Oaxaca",
      "2, Peninsulas of Sonora and Yucatán"
    ]
  },
  ru: {
