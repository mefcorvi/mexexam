...
export const question: QuestionData = {
  ...
  id: 'tno9tc',
  en: {
    question: 'Foreign battalion that participated and helped Mexico in the War against the US',
    answer: 'Saint Patrick\'s Battalion',
    options: [
      "Saint Cyprian's Battalion",
      "Saint James the Greater Battalion",
      "Saint Nicholas Battalion"
    ],
    note: 'It was a military unit composed of hundreds of European immigrants (Germans, Irish, and Americans) who fought in the Mexican army against the United States invasion from 1846 to 1848. They took the name from the Patron Saint of Ireland.'
  },
  ru: {
    question:
