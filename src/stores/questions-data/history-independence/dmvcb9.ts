...
export const question: QuestionData = {
  ...
  id: 'dmvcb9',
  en: {
    question: 'Technological contribution to the country during the government of Porfirio Diaz',
    ...
    note: 'On September 16, 1878. In a line that went from Chapultepec Castle to the National Palace.'
  },
  ru: {
    question:
  ...
  zh: {
    question: '在波菲里奥·迪亚斯政府期间对国家的技术贡献',
    answer: '电话',
    options: [
      "留声机",
      "电车",
    ...
    note: '1878年9月16日。从查普尔特佩克城堡到国家宫的线路。'
  }
};
