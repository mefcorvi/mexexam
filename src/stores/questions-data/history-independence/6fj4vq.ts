...
export const question: QuestionData = {
  ...
  id: '6fj4vq',
  en: {
    question: 'What happened to Iturbide after achieving Mexico\'s independence?',
    answer: 'In 1822, Iturbide was crowned as Agustín I Emperor of Mexico, amidst the political disorder of the country and Spain\'s refusal to acknowledge Mexico\'s independence.'
  },
  ru: {
    question:
