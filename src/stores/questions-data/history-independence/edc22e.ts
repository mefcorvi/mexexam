...
export const question: QuestionData = {
  ...
  id: 'edc22e',
  en: {
    question: 'Who was Leona Vicario?',
    answer: 'One of the most prominent women of the War of Independence',
    options: [
      "One of the most prominent women of the Revolution",
      "Prominent woman during the conquest",
      "Executed woman during the War of Independence"
    ],
    note: 'She dedicated herself to informing the insurgents of movements that might interest them and that were happening in the capital of the Viceroyalty.'
  },
  ru: {
