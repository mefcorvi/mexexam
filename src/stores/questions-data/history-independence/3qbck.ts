...
export const question: QuestionData = {
  ...
  id: '3qbck',
  en: {
    question: 'What is the Plan of Iguala?',
    answer: 'Political document proclaimed by Agustín de Iturbide, in which New Spain was declared a sovereign and independent country.',
    options: [
      "Proclaimed by General Santa Anna to disown Iturbide",
      "Treaty in which Mexico cedes northern territories",
      "Promoted by Porfirio Diaz to prevent the reelection of Benito Juárez"
    ]
  },
  ru: {
