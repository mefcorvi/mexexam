...
export const question: QuestionData = {
  ...
  id: 'fmrbfj',
  en: {
    question: 'Who designed Paseo de la Reforma and what was it called?',
    answer: 'Maximilian of Habsburg, it was called Paseo de la Emperatriz',
    options: [
      "Agustín de Iturbide, it was called Paseo del Emperador",
      "Cuauhtémoc, it was called Paseo del Imperio",
      "Guadalupe Victoria, it was called Paseo Guadalupe"
    ]
  },
  ru: {
