...
export const question: QuestionData = {
  ...
  id: 'zkhsfa',
  en: {
    question: 'What was the first newspaper of the insurgents (during the independence movement)?',
    answer: 'El Despertador Americano in 1810',
    options: [
      "El Informador Americano in 1910",
      "El Americano in 1510",
      "La Gaceta in 1710"
    ]
  },
  ru: {
