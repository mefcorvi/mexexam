...
export const question: QuestionData = {
  ...
  id: '56sg5n',
  en: {
    question: 'Who defeated Gen. Santa Anna at the Battle of San Jacinto on April 21, 1836?',
    answer: 'Gen. Samuel Houston (War against the US for Texas)',
    options: [
      "Gen. George C. Marshall (War against France)",
      "Gen. Douglas MacArthur (War against England)",
      "Gen. Henry H. Arnold (War against the US)"
    ]
  },
  ru: {
    question:
  ...
  zh: {
    question: '谁在1836年4月21日的圣哈辛托战役中击败了圣安娜将军？',
    answer: '塞缪尔·休斯顿将军（德克萨斯州与美国的战争）',
    options: [
      "乔治·C·马歇尔将军（与法国的战争）",
      "道格拉斯·麦克阿瑟将军（与英国的战争）",
      "亨利·H·阿诺德将军（与美国的战争）"
