...
export const question: QuestionData = {
  ...
  id: '803vqf',
  en: {
    question: 'Political-military movement led by Porfirio Díaz in 1871 to prevent the reelection of Benito Juárez',
    answer: 'Plan de Noria',
    options: [
      "Plan de Tuxtepec",
      "Plan de Iguala",
  ...
  zh: {
    question: '由波菲里奥·迪亚斯于1871年发起的政治军事运动，旨在阻止贝尼托·华雷斯连任',
    answer: '诺里亚计划',
    options: [
      "图斯特佩克计划",
      "伊瓜拉计划",
