...
export const question: QuestionData = {
  ...
  en: {
    question: 'Mexicans who have won the Nobel Prize',
    answer: 'Alfonso García Robles, Octavio Paz, José Mario Molina Pasquel y Henríquez',
    options: [
      "Juan Mendoza, Javier Aguirre and Joaquín Martinez",
      "Luis Barragan, Octavio Martinez and Juan Mendoza",
      "Rodolfo Vela, Erik Ochoa and Javier Del Toro Amezcua"
    ]
  }
};
