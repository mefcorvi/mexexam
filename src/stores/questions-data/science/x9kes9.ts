...
export const question: QuestionData = {
  ...
  en: {
    question: 'What is the record of the race that Ana Gabriela Guevara Espinoza won in 2003?',
    answer: '300 meters flat in 35.30 seconds',
    options: [
      "100 meters flat in 11.13 seconds",
