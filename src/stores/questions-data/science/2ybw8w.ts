...
export const question: QuestionData = {
  ...
  en: {
    question: 'Who invented color TV?',
    answer: 'Guillermo González Camarena',
    options: [
      "Guillermo Rivera",
      "Guillermo Aparicio",
    ...
    note: '\n\
      Guillermo González Camarena from Guadalajara, Jalisco, was the inventor of the \n\
      chromoscopic adapter for televisions, the first system for transmitting \n\
      color television. He was only 17 years old when he created this device during World War II. Camarena applied for the patent on August 14, 1941, and \n\
      obtained it on September 15, 1942. Later, his invention was used in the spacecraft "Voyager-1". On August 31, 1946, he made the first \n\
      color transmission from his laboratory at the office of the Mexican League of \n\
