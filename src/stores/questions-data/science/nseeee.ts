...
export const question: QuestionData = {
  ...
  en: {
    question: 'Name of the first Mexican astronaut',
    answer: 'Rodolfo Neri Vela',
    options: [
      "Gabriel Mendoza Soza",
      "Erik Ochoa Velez",
    ...
    note: '\n\
      The name of the first Mexican astronaut is Rodolfo Neri Vela. He made his\n\
      flight into space in 1985 aboard the space shuttle "Atlantis" as\n\
