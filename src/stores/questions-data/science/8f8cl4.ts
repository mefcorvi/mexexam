...
export const question: QuestionData = {
  ...
  en: {
    question: 'Mexican who won the Nobel Prize in Chemistry for his research on the ozone layer',
    answer: 'José Mario Molina Pasquel y Henríquez in 1995',
    options: [
      "Luis Ernesto Miramontes Cárdenas in 1994",
      "Rodolfo Neri Vela in 1992",
      "Guillermo Gonzalez Camarena in 1995"
    ],
    note: '\n\
      Mario José Molina-Pasquel Henríquez (March 19, 1943 - October 7, 2020) \n\
      was a Mexican physical chemist. He played a crucial role in the discovery \n\
      of the ozone hole in Antarctica and was a co-recipient of the Nobel Prize in \n\
