...
export const question: QuestionData = {
  ...
  en: {
    question: 'Record of the race in which Ana Gabriela Guevara was a medalist at the Athens 2004 Olympics',
    answer: 'Silver medal in 400m flat in 48.89 sec',
    options: [
      "Silver medal in 100m flat in 48.89 sec",
