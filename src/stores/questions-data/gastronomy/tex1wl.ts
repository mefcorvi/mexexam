...
export const question: QuestionData = {
  ...
  id: 'tex1wl',
  en: {
    question: 'Where is the dish of the 7 moles from?',
    answer: 'Oaxaca',
    options: [
      "Puebla",
      "Sonora",
    ...
    note: 'It is considered that Oaxacan mole is the combination of 7 moles from the region: mole negro, mole amarillo, mole colorado, mole verde, mole rojo, mole chichillo, and mole estofado.'
  },
  ru: {
  ...
  zh: {
    ...
    note: '瓦哈卡摩尔酱被认为是该地区七种摩尔酱的结合：黑摩尔、黄摩尔、红摩尔、绿摩尔、红色摩尔、鸡肉摩尔和炖摩尔。'
  }
};
