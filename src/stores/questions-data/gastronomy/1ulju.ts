...
export const question: QuestionData = {
  ...
  id: '1ulju',
  en: {
    question: 'What is the guanábana?',
    answer: 'Fruit with a green skin and white pulp',
    options: [
      "Refreshing drink from the state of Veracruz",
      "Typical dish from Tlaxcala made with corn and chicken meat",
      "Traditional sweet from Durango made with goat's milk"
    ]
  },
  ru: {
