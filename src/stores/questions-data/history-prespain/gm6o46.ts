...
export const question: QuestionData = {
  ...
  id: 'gm6o46',
  en: {
    question: 'When were the Sun and Moon pyramids built?',
    answer: 'Between the year 0 and 200 AD',
    options: [
      "Between the year 10 and 200 AD",
      "Between the year 100 and 300 AD",
      "Between the year 1 and 200 AD"
    ]
  },
  ru: {
