...
export const question: QuestionData = {
  ...
  id: '4igue',
  en: {
    question: 'What is pre-Hispanic Mexico?',
    answer: 'It is the period before the Spanish conquest and colonization of 1521, the history of the peoples who lived in this territory, the great cultures such as Olmec, Maya, Zapotec, Toltec, Purépecha, Aztec, among many others, who built an impressive lifestyle, agriculture, trade, art, architecture, and social organization that later dazzled the conquerors.'
  },
  ru: {
