...
export const question: QuestionData = {
  ...
  en: {
    question: 'Name of the altar built by a pre-Hispanic culture with a base decorated with carved stone skulls and stakes for impaling the heads of the sacrificed',
    answer: 'Tzompantli',
    options: [
      "Izquitl",
      "Tiyānquiztli",
