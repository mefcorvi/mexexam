...
export const question: QuestionData = {
  ...
  id: 'im3lar',
  en: {
    question: 'What was Teotihuacan?',
    answer: 'It was a ceremonial center and city',
    options: [
      "It was a secret city",
      "It was an island",
      "It was a Maya god"
    ],
    note: 'At its peak, the city housed at least 25,000 people, with the suburbs totaling around 150,000-200,000 people. Unlike other sites, Teotihuacan was a city with markets, neighborhoods of artisans and merchants. It was the most powerful civilization in Mesoamerica; no other city matched its size.'
  },
  ru: {
