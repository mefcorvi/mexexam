...
export const question: QuestionData = {
  ...
  id: '3f7mv',
  en: {
    question: 'When did the golden age of Mexican cinema begin?',
    answer: 'In 1935',
    options: [
      "In 1930",
      "In 1920",
    ...
    note: 'It symbolically began with the film Vámonos con Pancho Villa.'
  },
  ru: {
