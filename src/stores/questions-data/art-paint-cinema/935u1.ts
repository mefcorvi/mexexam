...
export const question: QuestionData = {
  ...
  id: '935u1',
  en: {
    question: 'What was the first movie filmed in Mexico?',
    answer: 'The President of the Republic (Porfirio Díaz) Riding a Horse in Chapultepec Forest in 1896',
    options: [
      "Let's Go",
      "Santa",
      "The Struggle"
  ...
  zh: {
    question: '在墨西哥拍摄的第一部电影是什么？',
    answer: '共和国总统（波菲里奥·迪亚斯）在1896年在查普尔特佩克森林骑马',
    options: [
      "走吧",
      "圣塔",
      "斗争"
