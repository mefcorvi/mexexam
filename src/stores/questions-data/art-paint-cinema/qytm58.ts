...
export const question: QuestionData = {
  ...
  id: 'qytm58',
  en: {
    question: 'Mexicans who have won Oscars for Best Director',
    answer: 'Alejandro González Iñárritu and Alfonso Cuarón',
    options: [
      "Guillermo del Toro and Anthonio Meza",
      "Eugenio Caballero and Alfonso Martinez",
      "Rodolfo Neri Vela and Eugenio Derbez"
    ],
    note: 'Alejandro González Iñárritu for Birdman in 2015 and for The Revenant in 2016, Alfonso Cuarón for Gravity in 2014 and for Roma in 2019.'
  },
  ru: {
  ...
  zh: {
    question: '获得奥斯卡最佳导演的墨西哥人',
    answer: '亚历杭德罗·冈萨雷斯·伊纳里图和阿方索·库阿罗',
    options: [
      "吉尔莫·德尔·托罗和安东尼奥·梅萨",
      "尤金尼奥·卡巴列罗和阿方索·马丁内斯",
      "罗道夫·内里·维拉和尤金尼奥·德尔贝兹"
    ],
    note: '亚历杭德罗·冈萨雷斯·伊纳里图因《鸟人》在2015年获奖，以及因《荒野猎人》在2016年获奖；阿方索·库阿罗因《地心引力》在2014年获奖，以及因《罗马》在2019年获奖。'
  }
};
