...
export const question: QuestionData = {
  ...
  en: {
    question: 'Who wrote "El ratón vaquero"?',
    answer: 'Cri Cri (Francisco Gabilondo Soler)',
    options: [
      "Octavio Paz",
      "Juan Rulfo",
    ...
    note: '"El ratón vaquero" is a very popular children\'s song in Mexico, written by the famous composer and singer Francisco Gabilondo Soler, known as Cri-Cri. Cri-Cri is an iconic figure in Mexican children\'s music, and his songs have entertained generations of children since the 1940s. "El ratón vaquero" tells the story of a mouse who arrives at a prison and communicates in English, adding a touch of humor and language learning to the song. Cri-Cri\'s creativity and storytelling have left a lasting mark on Mexican culture. His legacy lives on in the collective memory and in the hearts of many Mexican families.'
  },
  ru: {
  ...
  zh: {
    question: '谁写了《牛仔鼠》？',
    answer: 'Cri Cri（弗朗西斯科·加比隆多·索莱尔）',
    options: [
      "奥克塔维奥·帕斯",
      "胡安·鲁尔福",
      "卡洛斯·富恩特斯"
    ],
    note: '《牛仔鼠》是一首在墨西哥非常受欢迎的儿童歌曲，由著名作曲家和歌手弗朗西斯科·加比隆多·索莱尔创作，他以Cri-Cri而闻名。Cri-Cri是墨西哥儿童音乐的标志性人物，他的歌曲自20世纪40年代以来一直娱乐着几代孩子。《牛仔鼠》讲述了一只老鼠来到监狱并用英语交流的故事，为这首歌增添了一丝幽默和语言学习的元素。Cri-Cri的创造力和叙事风格在墨西哥文化中留下了持久的印记。他的遗产在集体记忆和许多墨西哥家庭的心中依然活着。'
  }
};
