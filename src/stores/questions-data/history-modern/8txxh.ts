...
export const question: QuestionData = {
  ...
  id: '8txxh',
  en: {
    question: 'When and who founded CONALEP?',
    answer: 'April 1978 by Eng. José Antonio Padilla Segura (presidency Lopez Portillo)',
    options: [
      "July 1998 by Eng. Rodolfo Neri Vela (presidency Lázaro Cárdenas)",
      "January 1783 by Eng. José Mario Molina (presidency López Mateos)",
      "March 1950 by Eng. Manuel Gutierrez (presidency Ruíz Cortines)"
    ]
  },
  ru: {
