...
export const question: QuestionData = {
  ...
  id: 'dw6dw',
  en: {
    question: 'On March 18, 1938, President Lázaro Cárdenas',
    answer: 'Nationalized the oil industry',
    options: [
      "Nationalized the mining industry",
      "Nationalized the textile industry",
      "Nationalized the chemical industry"
    ],
    note: 'Expropriated the assets of foreign oil companies.'
  },
  ru: {
  ...
  zh: {
    question: '1938年3月18日，总统拉萨罗·卡德纳斯',
    answer: '国有化了石油工业',
    options: [
      "国有化了矿业",
      "国有化了纺织工业",
