...
export const question: QuestionData = {
  ...
  id: 'kmzciw',
  en: {
    question: 'How did Mexico participate in World War II?',
    answer: 'By sending an expeditionary air force, "Escuadrón 201"',
    options: [
      "By sending oil and industrial products to the Allies",
      "By sending an expeditionary force of 500 men for the liberation of Paris",
      "By sending 2 frigates and a destroyer to the Pacific front"
    ]
  },
  ru: {
