...
export const question: QuestionData = {
  ...
  id: '25wlcj',
  en: {
    question: 'What is the Treaty of Tlatelolco?',
    answer: 'Agreement on the non-proliferation of nuclear weapons in Latin America',
    options: [
      "Document in which the Independence of Mexico is agreed",
      "Treaty that ended the war with the USA",
      "Free trade agreement with the USA and Canada"
    ]
  },
  ru: {
