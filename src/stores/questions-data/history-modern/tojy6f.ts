...
export const question: QuestionData = {
  ...
  id: 'tojy6f',
  en: {
    question: 'What was the name of the civil movement in Chiapas in 1994 led by Commander Marcos?',
    answer: 'Zapatista Movement / Chiapas Conflict / Zapatista Army of National Liberation (EZLN)',
    options: [
      "Fifth Republic Movement",
      "Citizen Movement for Justice July 5",
