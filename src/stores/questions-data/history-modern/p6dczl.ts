...
export const question: QuestionData = {
  ...
  id: 'p6dczl',
  en: {
    question: 'Which president inaugurated the Diana Cazadora?',
    answer: 'Manuel Ávila Camacho',
    options: [
      "Abelardo Rodríguez Lujan",
      "Emilio Portes Gil",
    ...
    note: 'On October 10, 1942, it is a monumental fountain located on Paseo de la Reforma avenue in Mexico City.'
  },
  ru: {
