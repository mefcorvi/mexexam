...
export const question: QuestionData = {
  ...
  id: 'hz6m7r',
  en: {
    question: 'Where are consumer complaints filed? or What is the consumer protection institution?',
    answer: 'PROFECO: Federal Consumer Prosecutor\'s Office',
    options: [
      "POFECO: Federal Power of the Consumer",
      "MINCO: National Consumer Ministry",
      "MINPROCON: Ministry of Consumer Protection"
    ]
  },
  ru: {
    question:
      'Где можно подать жалобу потребителя? или Какое учреждение занимается защитой прав потребителей?',
    answer: 'PROFECO: Федеральная прокуратура по защите прав потребителей',
    options: [
