...
export const question: QuestionData = {
  ...
  id: 'lycqq7',
  en: {
    question: 'The organization responsible for regulating the participation of political parties in elections is',
    answer: 'INE (National Electoral Institute)',
    options: [
      "IFE (Federal Electoral Institute)",
      "CNE (National Electoral Council)",
      "CFE (Federal Electoral Commission)"
    ],
    note: 'As of April 4, 2014, it was previously known as the Federal Electoral Institute (IFE).'
  },
  ru: {
    question:
  ...
  zh: {
    ...
    note: '自2014年4月4日起，之前是联邦选举委员会（IFE）。'
  }
};
