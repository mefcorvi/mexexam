...
export const question: QuestionData = {
  ...
  id: 'l7gfov',
  en: {
    question: 'What document governs foreigners and Mexicans in national territory or what document grants rights to Mexicans?',
    answer: 'Political Constitution of the United Mexican States',
    options: [
      "Mexican Constitution",
      "Book of Laws of the Mexican Republic",
      "National Regulations of the United Mexican States"
    ]
  },
  ru: {
    question:
  ...
  zh: {
    question: '什么文件规范外国人和墨西哥人在国家领土上的行为，或者哪个文件赋予墨西哥人权利？',
    answer: '墨西哥合众国政治宪法',
    options: [
      "墨西哥宪法",
      "墨西哥共和国法律书",
