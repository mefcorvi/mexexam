...
export const question: QuestionData = {
  ...
  id: 'eziegc',
  en: {
    question: 'When was the National Anthem declared official?',
    answer: '1943 during the presidency of Manuel Ávila Camacho',
    options: [
      "1950 during the presidency of Lázaro Cárdenas",
      "1982 during the presidency of López Mateos",
      "1945 during the presidency of Díaz Ordaz"
    ]
  },
  ru: {
  ...
  zh: {
    question: '国歌是什么时候被正式宣布的？',
    answer: '1943年，在曼努埃尔·阿维拉·卡马乔总统任内',
    options: [
      "1950年，在拉萨罗·卡德纳斯总统任内",
      "1982年，在洛佩斯·马特奥斯总统任内",
      "1945年，在迪亚斯·奥尔达斯总统任内"
