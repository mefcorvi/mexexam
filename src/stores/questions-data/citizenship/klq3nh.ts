...
export const question: QuestionData = {
  ...
  id: 'klq3nh',
  en: {
    question: 'How long does the primary SCHOOL YEAR last in Mexico?',
    answer: '1 year',
    options: [
      "2 years",
      "3 years",
    ...
    note: 'It is different from how long primary school lasts, which is 6 years.'
  },
  ru: {
