...
export const question: QuestionData = {
  ...
  id: 'fxlk4',
  en: {
    question: 'According to the constitution, education is mandatory. At what academic levels?',
    answer: 'Preschool, primary, secondary, and preparatory or high school',
    options: [
      "Primary, secondary, and preparatory or high school",
